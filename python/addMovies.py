...
def createNodesfromMovieFile(filename):
    ...
    with open(filename, 'r') as f1, open('txt/images.txt', 'r') as f2, open('txt/adjectives.txt', 'r') as f3, open('txt/descriptions.txt', 'r') as f4 :
...
if __name__ == "__main__":
    ...
    createNodesfromMovieFile('txt/movies.txt')